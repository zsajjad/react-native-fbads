...
public class NativeAdView extends ReactViewGroup {
  ...
  public void setNativeAd(NativeAd nativeAd) {
    ...
    Log.d("NativeAdView", "Is add loaderd? " + (nativeAd.isAdLoaded() ? "true" : "false"));
    Log.d("NativeAdView", nativeAd.getAdChoicesLinkUrl());
    Log.d("NativeAdView", nativeAd.getAdChoicesIcon().getUrl());

    AdChoicesView adChoicesView = new AdChoicesView(mContext, nativeAd, true);
    adChoicesView.measure(5000, 500);
    adChoicesView.layout(400, 150, 5000, 650);
